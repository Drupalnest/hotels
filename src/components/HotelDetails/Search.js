...
//     // Trigger the opening of the date picker for the start date
//     document.getElementById("start-date-picker").click();
//   };

//   const handleEndDateClick = () => {
//     // Trigger the opening of the date picker for the end date
//     document.getElementById("end-date-picker").click();
//   };
...
//         >
//           <StyledDatePicker
//             id="start-date-picker" // Assign an id to the date picker
//             selected={startDate}
...
//           />
//           <StyledDatePicker
//             id="end-date-picker" // Assign an id to the date picker
//             selected={endDate}
