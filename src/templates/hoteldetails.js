...
const HotelDetails = ({ data }) => {
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="container m-6 border mx-auto flex flex-col justify-center  border-green-500">
        <div className="container  ">
          ...
          <div className="flex flex-wrap justify-center items-start border border-blue-500 p-4">
            <div className="m-4">
            ...
            <div className="border border-blue-500 m-4 p-4">
          ...
          <div className="container mx-auto p-4 border border-yellow-700">
          ...
          <div>
            ...
            <p>
              ...
              pool and sun terrace, and guests can enjoy a meal at the
              restaurant. Breakfast inclusive rates include the Crescent City
              breakfast - It includes 2 eggs, meat, toast, potatoes or grits.
              Every room is equipped with a flat-screen TV with satellite
              channels. Certain units include a seating area for your
              convenience. Each room is equipped with a private bathroom. There
              is a 24-hour front desk. The hotel also offers bike hire and car
              hire. Bourbon Street is 0.6 mi from NOPSI Hotel, New Orleans,
              while Mercedes-Benz Superdome is 0.7 mi from the property. The
              nearest airport is Louis Armstrong New Orleans International
              Airport, 11 mi from the property.
            </p>
          </div>
          ...
          <div className="flex flex-row">
            ...
            <span>
              ...
              <span>
                ...
                was very professionally handled by the manager. She clearly
                cared about us having a pleasant stay & went out of her way to
                ensure that happened. We were very happy with our room & the
                service we received. Thanks Was there anything you didn't like?
                No
              </span>
            </span>
          </div>
